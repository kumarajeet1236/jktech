...
import { mockUserEntity } from "src/modules/user/entities/__fixtures__/user-entity.fixture";
...
describe("IngestionService", () => {
  ...
  it("should add ingestion", async () => {
    ...
    expect(ingestionClient.send).toHaveBeenCalledWith("addIngestion", {
      userId: 1,
      documentId: 1,
    });
  ...
  it("should find ingestion by id", async () => {
    ...
    expect(ingestionClient.send).toHaveBeenCalledWith("getIngestion", 1);
